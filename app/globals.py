...
from app.task import Task, MaxTempTask, MinTempTask, ProxTask, TouchTask, ProxTask1
...
def initialize():
    ...
    for i, device in enumerate(device_list):
        ...
        elif device_list[i] == "Sens-O-lympics Prox 0":
            task_cls = ProxTask
        elif device_list[i] == "Sens-O-lympics Prox 1":
            task_cls = ProxTask1
